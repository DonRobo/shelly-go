	...
	}{
		{
			...
			expect: InputCheckExpressionResponse{
				Results: []InputCheckExpressionResult{
					{
						Input:  rpc.Float64Ptr(1),
						Output: rpc.Float64Ptr(4.333333),
					},
					{
						Input:  rpc.Float64Ptr(2),
						Output: rpc.Float64Ptr(4.666667),
					},
					{
						Input:  rpc.Float64Ptr(3),
						Output: rpc.Float64Ptr(5),
					},
				},
			},
		},
				...
				Results: []InputCheckExpressionResult{
					{
						Input:  rpc.Float64Ptr(1),
						Output: rpc.Float64Ptr(4.333333),
						Error:  rpc.StrPtr("this is an error"),
					},
				},
			},
		},
